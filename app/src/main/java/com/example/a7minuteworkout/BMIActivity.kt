...
class BMIActivity : AppCompatActivity() {
    ...
    private var currentVisibilityView: String = METRIC_UNITS_VIEW
    ...
    private fun makeVisibleMetricUnitsView() {
        currentVisibilityView = METRIC_UNITS_VIEW
    ...
    private fun makeVisibleUsMetricUnitsView() {
        currentVisibilityView = US_UNITS_VIEW
    ...
    private fun calculateUnits() {
        if (currentVisibilityView == METRIC_UNITS_VIEW) {
