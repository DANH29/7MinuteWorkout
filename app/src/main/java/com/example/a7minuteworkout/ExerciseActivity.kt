...
import com.example.a7minuteworkout.databinding.DialogCustomBackConfigurtationBinding
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun customDialogForBackButton() {
        ...
        val dialogBinding =
            DialogCustomBackConfigurtationBinding.inflate(layoutInflater)
    ...
    private fun setupRestView() {
        try {
            val soundURI = Uri.parse(
                "android.resource://com.example.a7minuteworkout/"
